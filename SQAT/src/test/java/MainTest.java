...
public class MainTest {
    ...
    public void mainTest() throws InterruptedException {
        ...
        webDriver.findElement(usernameBy).sendKeys("7028655538");
        webDriver.findElement(passwordBy).sendKeys("Kd30062019!", Keys.ENTER);
    ...
    public void hybridMail() throws InterruptedException{
        ...
        webDriver.findElement(senderIndexBy).sendKeys("010000");
